...
- `replication-package.zip`: Java source, configuration, calibration source observations, court-profile index and benchmark cards, empirical platform coverage/readiness reports, compact aggregate reports, provenance manifests, and reproduction commands.
    ...
    excluded_artifacts.write_text(
        "\n".join(
            [
                ...
                "",
                "These files are generated by `make campaign`, `make paired-campaign`, `make validation-check`, and `make sensitivity-check`.",
