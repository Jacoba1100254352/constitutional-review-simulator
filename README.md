...
leakage. The review replication ZIP excludes the largest raw
`reports/*-cases.csv.gz` outputs to keep the upload practical; those case-level
exports are regenerated by the campaign commands and listed in
