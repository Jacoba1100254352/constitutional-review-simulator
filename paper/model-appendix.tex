...
This appendix states the model in compact notation so the simulation can be evaluated without first reading the Java source. The implementation remains deterministic conditional on the random seed, scenario configuration, world specification, and imported legislative signals.
