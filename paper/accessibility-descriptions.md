...
follow-up. The current-style court has higher shadow-docket abuse than the
...
designs move differently as the docket source changes, showing why imported
legislative outputs are useful stress tests.

`fig:cost-score`: Scatterplot of baseline total institutional cost against
directional diagnostic score. The current-style court appears at the lower-cost
