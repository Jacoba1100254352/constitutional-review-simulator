...
\begin{abstract}
This article introduces a transparent simulation framework for stress-testing constitutional-review design bundles under shared synthetic dockets. The framework does not predict the behavior of existing courts. It is a structured implication engine: if institutional mechanisms are modeled through stated access, routing, emergency, decision, response, compliance, cost, and political-culture assumptions, the simulator shows the tradeoff maps those assumptions imply. The paper's conceptual focus is veto-relocation risk, or the possibility that review protects rights while moving final policy control into less visible courts, councils, screeners, emergency orders, or legislative-response stages. Named-system-inspired presets are treated as stylized archetypes and external diagnostic comparators, not fitted country models. The empirical contribution is limited to source-specific diagnostic checks with documented sources, denominators, and direct target analogues; broader comparative rows remain stress-test assumptions. Under the baseline assumptions, mechanisms perform best when they preserve rights-sensitive review while making veto relocation visible and requiring credible democratic response. The design recommendations are therefore conditional, assumption-sensitive, and separable from the synthetic outputs that generate them.
\end{abstract}
...
The article's main contribution is methodological. It offers a computational framework for comparing constitutional-review design bundles under shared assumptions. The model is deliberately stylized. It does not forecast the U.S. Supreme Court, the German Federal Constitutional Court, or any other tribunal. It asks a narrower and more auditable question: if one specifies a docket generator, review pipeline, institutional mechanisms, response rules, costs, and scoring conventions, which tradeoffs become visible when each design faces the same synthetic worlds?

That framing matters because many constitutional-review reforms do not eliminate veto power. They move it. A court-expansion plan may relocate veto power into appointment timing. A council may move it into pre-enactment or abstract screening. Weak-form review may move it into legislative response capacity. Rights-impact statements may move it into executive drafting and certification. Emergency relief may move it into opaque interim orders. This paper calls that risk veto-relocation risk and treats it as the central diagnostic rather than as an afterthought.

The paper therefore presents itself as a comparative stress-testing framework, not as an empirical ranking of constitutional courts. Named-system-inspired presets are renamed and interpreted as stylized institutional archetypes: U.S.-style discretionary apex review, Kelsenian constitutional-court review, council-style pre-enactment and abstract review, weak-form parliamentary review, supranational treaty review, and dual-court or cross-checking review. They remain useful because they discipline the scenario catalog, but they are not fitted replicas. The external diagnostic checks later in the paper show where the source-specific fit is weak and where future calibration work should begin.

The framework can also use legislative-output profiles as subject-matter-preserving docket stress signals. That bridge makes it possible to ask whether a review design behaves differently when the docket is produced by high capture, high volatility, low mandate, or baseline legislative outputs. The bridge is secondary to the paper's contribution, and it is treated as a stress input rather than as validation of either simulator.

The central question is when constitutional review improves democratic constitutionalism rather than merely relocating veto power. The answer offered here is conditional: under stated model assumptions, mechanisms are attractive only when they preserve rights-sensitive review, make veto relocation visible, and generate credible democratic response without excessive conflict, cost, or political-culture dependence. The rest of the article is organized for a law-and-courts audience. Section~\ref{sec:infrastructure} defines constitutional review as institutional infrastructure. Section~\ref{sec:framework} describes the simulation framework. Section~\ref{sec:experiments} summarizes the comparative stress tests. Section~\ref{sec:diagnostics} reports external diagnostic comparisons, uncertainty, and replication limits. Section~\ref{sec:implications} identifies implications for institutional design. Section~\ref{sec:limits} discusses limitations and next steps.
...
\toprule
Scenario group & Examples in reported campaign & Primary tradeoff diagnosed \\
\midrule
\endfirsthead
\toprule
Scenario group & Examples in reported campaign & Primary tradeoff diagnosed \\
\midrule
\endhead
Court-architecture variants & Current-style discretionary apex court; 18-year terms; commission appointment; supermajority invalidation; strict recusal; panel/en banc routing; dual cross-checking courts; constitutional council; legislative override; retention accountability; hybrid independence/accountability. & Whether selection, size, threshold, routing, and accountability reforms change rights, legitimacy, conflict, cost, and veto-relocation diagnostics when the docket is held fixed. \\
...
Stylized archetype presets & U.S.-style discretionary apex review, Kelsenian constitutional-court review, council-style pre-enactment or abstract review, weak-form parliamentary review, supranational treaty review, and dual-court/cross-checking review. & External diagnostic comparison and scenario discipline only; these are not fitted country replicas. \\
...
The project therefore separates three evidentiary categories. Stylized archetype presets encode observable institutional rules and cost/intake context inspired by named systems, but they are not fitted replicas. Synthetic mechanisms isolate reform ideas that may have comparative analogues but are not country presets. Speculative design recommendations are conditional inferences from those synthetic comparisons; they are not empirical claims about the systems that inspired a mechanism.
...
The democratic-constitutionalism diagnostic is not offered as a universal constitutional theory. It combines rights protection, democratic responsiveness, legality, legitimacy, compliance, low conflict, low veto-relocation risk, access, implementation capacity, transplant feasibility, and political-culture robustness because those are the values most directly implicated by the design bundles modeled here. A rights-centered reader could weight rights protection more heavily; a parliamentary constitutionalist could weight legislative response and democratic responsiveness more heavily; a legal-stability theorist could weight precedent durability and compliance more heavily; and a public-administration reader could weight cost and implementation more heavily. The experiments therefore report direct outputs first, use the composite score only as a display aid, and add alternative normative profiles rather than asking the reader to accept a single welfare function.
...
\midrule
Generated case facts & Bounded $[0,1]$ synthetic draws with correlations among rights threat, urgency, salience, ambiguity, public support, lower-court conflict, and policy domain. & Creates the shared docket faced by each scenario. & Design prior; stress-tested through campaign cases and legislative-output imports. \\
World context & Bounded controls for appointment polarization, rights-threat rate, emergency pressure, legislative conflict, public trust, partisan pressure, fragmentation, government control, electoral time pressure, civil society, implementation capacity, and legal-tradition fit. & Shapes docket stress, replacement dynamics, compliance, and response. & Stress-case parameter; country-context rows are diagnostic comparators, not fitted estimates. \\
Institutional rules & Scenario-coded court size, appointment method, tenure, removal, recusal, routing, emergency procedure, voting threshold, council/cross-checking, override, and weak-form mechanisms. & Determines intake, voting, emergency handling, response, cost, and veto-relocation channels. & Institutional mapping or synthetic mechanism flag. \\
...
External diagnostic targets & Source-backed rows with source URL, denominator, construction note, and direct simulator analogue; contextual rows are retained but excluded from fit counts. & Finds missing mechanisms and denominator problems. & External diagnostic comparison only. \\
\bottomrule
\end{tabular}
\end{table}
...
The paired-input campaign is a docket-source stress test rather than an empirical validation of the legislative simulator. Each imported legislative row becomes a stress signal that preserves subject matter when a \texttt{policyDomain} column is available and otherwise infers one from row labels and stress fields. The five docket modes are synthetic baseline (SB), all imported rows (ALL), high lobby-capture rows (CAP), high policy-volatility rows (VOL), and low public-mandate rows (MAND). Imported rows change rights threat, public support, legislative mandate, policy-domain mix, capture pressure, volatility, and emergency pressure; they do not change the constitutional-review rules themselves.

Figure~\ref{fig:paired-import} shows the paired-input campaign as a design stress test. Legislative-output profiles can change the relative diagnostic score of each design, which is why cross-institutional stress testing is useful. The figure remains secondary to Tables~\ref{tab:baseline-results}--\ref{tab:normative-profiles} because its docket sources depend on a separate simulator contract.

\begin{figure}[hbt!]
\centering
\input{figures/paired_import_lines}
\caption{Directional diagnostic scores under synthetic and legislative-output docket sources. SB means synthetic baseline, ALL all imported rows, CAP high capture, VOL high volatility, and MAND low mandate. The score is a compact display aid, not a welfare function. CUR* marks the current-style scenario.}
