...
large `reports/*-cases.csv.gz` raw case exports; those files are regenerated by
the campaign commands and should be deposited with the final public replication
archive or supplied separately on request.
...
- generated aggregate reports, run-block bootstrap intervals, and a manifest of
  omitted case-level exports for review upload;
