...
The supplementary replication package is designed to include the simulator source and tests, calibration and benchmark inputs, research-roadmap and source-candidate files, the normalized calibration source-observation matrix, compact generated reports, figure- and table-generation scripts, and reproduction commands. Detailed directory paths are documented in the replication README rather than in the article text. Full compressed case-level and interval exports are reproducible from those commands and should be included in the final public deposit or supplied separately if requested. For anonymous review, any repository metadata or file paths that identify the author should be removed or redacted from the submitted archive.
