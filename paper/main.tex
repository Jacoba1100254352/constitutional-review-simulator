...
\caption{Directional diagnostic scores under synthetic and imported legislative docket sources. The score is a compact display aid, not a welfare function.}
...
\caption{Baseline institutional cost versus directional diagnostic score. The diagnostic score summarizes multiple directional metrics for display only; individual metric tables remain the substantive evidence.}
