...
- The review replication ZIP excludes the largest `reports/*-cases.csv.gz`
  outputs and run-block interval CSVs and includes
  `excluded-large-artifacts.txt`; those outputs are regenerated by the campaign
  commands and should be included in the final public replication deposit or
