...
)
{
	private static final List<MetricDefinition> DEFINITIONS = List.of(
			...
			new MetricDefinition("shadowDocketAbuse", "Emergency-process irregularity", MetricDirection.LOWER_IS_BETTER, "Opaque, unexplained, high-impact, or merits-displacing emergency action."),
			new MetricDefinition("legitimacy", "Modeled public-legitimacy proxy", MetricDirection.HIGHER_IS_BETTER, "Synthetic process-legitimacy index combining trust, transparency, agreement, rights performance, and conflict."),
			...
			new MetricDefinition("emergencyPublicDisagreementRate", "Emergency public disagreement", MetricDirection.LOWER_IS_BETTER, "Share of emergency orders with public dissents, concurrences, or visible disagreement."),
			new MetricDefinition("governmentEmergencyWinRate", "Government emergency win rate", MetricDirection.DIAGNOSTIC, "Government emergency applicants receiving the requested interim outcome."),
			new MetricDefinition("meritsFollowUpRate", "Emergency merits follow-up", MetricDirection.HIGHER_IS_BETTER, "Emergency matters later routed into merits review."),
			...
			new MetricDefinition("legislativeResponseCredibility", "Legislative response credibility", MetricDirection.HIGHER_IS_BETTER, "Modeled capacity and incentive for legislatures to respond constructively to review."),
			new MetricDefinition("caseSelectionAccess", "Case-selection access", MetricDirection.HIGHER_IS_BETTER, "Access to constitutional review after litigant capacity, public-interest support, and intake filtering."),
			new MetricDefinition("governmentRepeatPlayerAdvantage", "Government repeat-player advantage", MetricDirection.LOWER_IS_BETTER, "Procedural or capacity advantage for repeat government litigants in the review pipeline."),
			new MetricDefinition("implementationCapacity", "Implementation capacity", MetricDirection.HIGHER_IS_BETTER, "Modeled ability of public institutions to implement review outcomes despite cost and conflict."),
			new MetricDefinition("democraticConstitutionalism", "Democratic constitutionalism", MetricDirection.HIGHER_IS_BETTER, "Joint rights, responsiveness, legitimacy, compliance, implementation, access, feasibility, and low veto-relocation performance."),
			new MetricDefinition("vetoRelocationRisk", "Veto-relocation risk", MetricDirection.LOWER_IS_BETTER, "Risk that review simply shifts veto power to courts, councils, screeners, or unaccountable follow-up stages."),
			new MetricDefinition("legalTransplantFeasibility", "Legal-transplant feasibility", MetricDirection.HIGHER_IS_BETTER, "Fit between the review mechanism, expected institutional capacity, and transplantability outside its home setting."),
			new MetricDefinition("politicalCultureSensitivity", "Political-culture sensitivity", MetricDirection.LOWER_IS_BETTER, "How strongly the design depends on trust, low polarization, compliance culture, and cooperative legislative response."),
			...
			new MetricDefinition("invalidationLegislativeReenactmentRate", "Post-invalidation reenactment", MetricDirection.LOWER_IS_BETTER, "Reenactment or effective override share among merits invalidations."),
			...
			new MetricDefinition("weakFormDeclarationRate", "Weak-form declaration rate", MetricDirection.DIAGNOSTIC, "Share of cases producing nonbinding declarations or dialogue review findings."),
			new MetricDefinition("suspendedDeclarationRate", "Suspended declaration rate", MetricDirection.DIAGNOSTIC, "Share of cases where invalidity is declared but delayed for legislative correction."),
			new MetricDefinition("legislativeResponseRate", "Legislative response rate", MetricDirection.HIGHER_IS_BETTER, "Share of cases receiving a modeled legislative response after a declaration, override, or mandatory response trigger."),
			new MetricDefinition("invalidationLegislativeResponseRate", "Post-invalidation response rate", MetricDirection.HIGHER_IS_BETTER, "Share of merits invalidations followed by a modeled legislative response."),
			new MetricDefinition("rightsImpactStatementRate", "Rights-impact statement rate", MetricDirection.DIAGNOSTIC, "Share of cases screened through modeled legislative rights-impact statement procedures."),
			new MetricDefinition("ombudsmanTriggerRate", "Ombudsman trigger rate", MetricDirection.DIAGNOSTIC, "Share of cases with modeled ombudsman-triggered access to constitutional review."),
			new MetricDefinition("publicDefenderParticipationRate", "Public-defender participation rate", MetricDirection.DIAGNOSTIC, "Share of cases with modeled constitutional public-defender participation."),
			new MetricDefinition("preEnactmentReviewRate", "Pre-enactment review rate", MetricDirection.DIAGNOSTIC, "Share of cases routed through pre-enactment review."),
			new MetricDefinition("abstractReviewRate", "Abstract review rate", MetricDirection.DIAGNOSTIC, "Share of cases routed through abstract or noncase-specific review."),
			new MetricDefinition("preliminaryReferenceRate", "Preliminary-reference route rate", MetricDirection.DIAGNOSTIC, "Share of docket entering through a supranational preliminary-reference route."),
			new MetricDefinition("appealRouteRate", "Appeal route rate", MetricDirection.DIAGNOSTIC, "Share of docket entering through a supranational appeal route."),
			new MetricDefinition("directActionRate", "Direct-action route rate", MetricDirection.DIAGNOSTIC, "Share of docket entering through a supranational direct-action route."),
			...
			new MetricDefinition("directCourtCost", "Direct court cost", MetricDirection.LOWER_IS_BETTER, "Benchmarked direct court staffing, budget, and institutional scale burden."),
			new MetricDefinition("upstreamScreeningCost", "Upstream screening cost", MetricDirection.LOWER_IS_BETTER, "Benchmark and docket-control burden shifted into intake filters or lower courts."),
			new MetricDefinition("capacityStrainCost", "Capacity strain cost", MetricDirection.LOWER_IS_BETTER, "Capacity pressure from filings, emergency load, cross-checks, and turnover."),
