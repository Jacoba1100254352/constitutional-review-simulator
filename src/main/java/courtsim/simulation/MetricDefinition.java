...
public record MetricDefinition(
    ...
    private static final List<MetricDefinition> DEFINITIONS = List.of(
            ...
            new MetricDefinition("democraticConstitutionalism", "Democratic constitutionalism", MetricDirection.HIGHER_IS_BETTER, "Joint rights, responsiveness, legitimacy, compliance, feasibility, and low veto-relocation performance."),
